 ...
 * \addtogroup PedUnit
 * 
 * \brief The PedUnit module provides a standard mechanism for describing and parsing
 * locations within devices in human-friendly plain text. 
 *
 ...
 * to provide a consistent system for describing device locations all throughout 
 * libparted.
 * 
...
/**
 * \brief Get a string that describes the location of the \p byte on device \p dev.
 * 
 ...
 * assumed. 
 *
 * \throws PED_EXCEPTION_ERROR if \p str contains invalid description of a location
